...
- Keep the DraftKings placeholders compact and explicit: salary is labeled `DK$`, projection is labeled `DK FPTX`, and both remain visibly unavailable until a real source is connected.
